...
namespace dak::six_eight::tests
{
   ...
   public:
      ...
      TEST_METHOD(rotate_position)
      {
         ...
         Assert::AreEqual(position_t( 1,  0), position_t(-1, 0).rotate(2));
         Assert::AreEqual(position_t( 0,  1), position_t(-1, 0).rotate(3));

         Assert::AreEqual(position_t(-1,  1), position_t(-1, 1).rotate(0));
         Assert::AreEqual(position_t(-1, -1), position_t(-1, 1).rotate(1));
         Assert::AreEqual(position_t( 1, -1), position_t(-1, 1).rotate(2));
         ...
         for (int scale = -7; scale < 7; ++scale)
         {
            ...
            Assert::AreEqual(position_t( 1 * scale,  0 * scale), position_t(-1 * scale, 0 * scale).rotate(2));
            Assert::AreEqual(position_t( 0 * scale,  1 * scale), position_t(-1 * scale, 0 * scale).rotate(3));

            Assert::AreEqual(position_t(-1 * scale,  1 * scale), position_t(-1 * scale, 1 * scale).rotate(0));
            Assert::AreEqual(position_t(-1 * scale, -1 * scale), position_t(-1 * scale, 1 * scale).rotate(1));
            Assert::AreEqual(position_t( 1 * scale, -1 * scale), position_t(-1 * scale, 1 * scale).rotate(2));
      ...
      TEST_METHOD(rotate_in_place_position)
      {
         ...
         Assert::AreEqual(position_t( 1,  0), position_t(-1, 0).rotate_in_place(2));
         Assert::AreEqual(position_t( 0,  1), position_t(-1, 0).rotate_in_place(3));

         Assert::AreEqual(position_t(-1,  1), position_t(-1, 1).rotate_in_place(0));
         Assert::AreEqual(position_t(-1, -1), position_t(-1, 1).rotate_in_place(1));
         Assert::AreEqual(position_t( 1, -1), position_t(-1, 1).rotate_in_place(2));
         ...
         for (int scale = -7; scale < 7; ++scale)
         {
            ...
            Assert::AreEqual(position_t( 1 * scale,  0 * scale), position_t(-1 * scale, 0 * scale).rotate_in_place(2));
            Assert::AreEqual(position_t( 0 * scale,  1 * scale), position_t(-1 * scale, 0 * scale).rotate_in_place(3));

            Assert::AreEqual(position_t(-1 * scale,  1 * scale), position_t(-1 * scale, 1 * scale).rotate_in_place(0));
            Assert::AreEqual(position_t(-1 * scale, -1 * scale), position_t(-1 * scale, 1 * scale).rotate_in_place(1));
            Assert::AreEqual(position_t( 1 * scale, -1 * scale), position_t(-1 * scale, 1 * scale).rotate_in_place(2));
